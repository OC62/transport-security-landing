  ...
  const jobs = [
    {
      ...
      description: "Обеспечение безопасности на транспортных объектах, проведение аудитов, разработка рекомендаций.",
      requirements: [
        "Высшее образование в области безопасности",
        "Опыт работы от 3 лет",
        "Наличие сертификата по транспортной безопасности",
        "Знание законодательства в сфере безопасности"
      ],
      responsibilities: [
    ...
    {
      id: 2,
      title: "Аналитик по угрозам",
      department: "Аналитический отдел",
      location: "Санкт-Петербург",
      type: "Полная занятость",
      description: "Анализ потенциальных угроз, мониторинг ситуации, разработка прогнозов.",
      requirements: [
        "Высшее образование в области анализа данных или безопасности",
        "Опыт работы от 2 лет",
        "Навыки работы с системами аналитики",
        "Аналитическое мышление"
      ],
      responsibilities: [
        "Сбор и анализ данных",
        "Разработка прогнозов угроз",
        "Подготовка аналитических отчетов",
        "Участие в оперативных совещаниях"
      ]
    },
    {
      id: 3,
      ...
      type: "Полная занятость",
      description: "Ведение переговоров с клиентами, презентация услуг, сопровождение проектов.",
      requirements: [
        "Высшее образование",
        "Опыт B2B продаж от 2 лет",
        "Знание основ транспортной безопасности",
