  ...
  return (
    <section id="about" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        {/* Слайдер с фото команды (перемещён вниз) */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, margin: "-100px" }}
        ...
        >
          ...
          <div className="w-full h-80 rounded-lg overflow-hidden"> {/* Увеличена высота: h-80 */}
            <Swiper
              modules={[Autoplay]}
              spaceBetween={0}
              slidesPerView={1}
            ...
            >
              {teamPhotos.map((member, index) => (
                <SwiperSlide key={index}>
                  <div className="relative w-full h-80"> {/* Та же высота */}
                    <img
                      src={member.src}
